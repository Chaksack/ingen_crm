...
// node_modules/@number-flow/vue/dist/index.js
import { defineComponent as T, provide as P2, renderSlot as b2, watch as M2, nextTick as g, onUnmounted as B2, ref as p, computed as c, inject as E2, openBlock as A2, createElementBlock as F2, mergeProps as L2, unref as v2, onMounted as N2, watchEffect as $2, toValue as h } from "vue";
...
var l = {
  onUpdate(e, n, o) {
    if (i.set(o, void 0), !o.computedTrend)
      return;
    const s = n.integer.concat(n.fraction).filter((t) => t.type === "integer" || t.type === "fraction"), r = e.integer.concat(e.fraction).filter((t) => t.type === "integer" || t.type === "fraction"), u2 = s.find((t) => !r.find((c2) => c2.pos === t.pos && c2.value === t.value)), a = r.find((t) => !s.find((c2) => t.pos === c2.pos && t.value === c2.value));
...
function nt(n, t, e, i2) {
  ...
  const a = [], r = [], o = [], c2 = [], d = {}, p2 = (h2) => `${h2}:${d[h2] = (d[h2] ?? -1) + 1}`;
  let x2 = "", g2 = false, y = false;
  for (const h2 of s) {
    x2 += h2.value;
    const l2 = h2.type === "minusSign" || h2.type === "plusSign" ? "sign" : h2.type;
    l2 === "integer" ? (g2 = true, r.push(...h2.value.split("").map((C) => ({ type: l2, value: parseInt(C) })))) : l2 === "group" ? r.push({ type: l2, value: h2.value }) : l2 === "decimal" ? (y = true, o.push({ type: l2, value: h2.value, key: p2(l2) })) : l2 === "fraction" ? o.push(...h2.value.split("").map((C) => ({
      type: l2,
      value: parseInt(C),
      key: p2(l2),
      pos: -1 - d[l2]
  ...
  const T2 = [];
  for (let h2 = r.length - 1; h2 >= 0; h2--) {
    const l2 = r[h2];
    T2.unshift(l2.type === "integer" ? {
      ...l2,
      key: p2(l2.type),
      pos: d[l2.type]
    } : {
...
var J = class extends G {
  ...
  set data(t) {
    ...
    if (this.created) {
      const c2 = this._data;
      this._data = t, this.computedTrend = typeof this.trend == "function" ? this.trend(c2.value, r) : this.trend, this.computedAnimated = q && this._animated && (!this.respectMotionPreference || !(A != null && A.matches)) && // https://github.com/barvian/number-flow/issues/9
      H(this), (o = this.plugins) == null || o.forEach((d) => {
        var p2;
        return (p2 = d.onUpdate) == null ? void 0 : p2.call(d, t, c2, this);
      ...
      if (typeof CSSStyleSheet < "u" && this.shadowRoot.adoptedStyleSheets)
        ...
        c2.textContent = M, this.shadowRoot.appendChild(c2);
      }
...
var W = class {
  constructor(t, e, { justify: i2, className: s, ...a }, r) {
    this.flow = t, this.children = /* @__PURE__ */ new Map(), this.onCharRemove = (c2) => () => {
      this.children.delete(c2);
    }, this.justify = i2;
    const o = e.map((c2) => this.addChar(c2).el);
    this.el = u("span", {
      ...a,
...
var D = class extends B {
  constructor(t, e, i2, s, a) {
    var d, p2;
    const r = (((p2 = (d = t.flow.digits) == null ? void 0 : d[s]) == null ? void 0 : p2.max) ?? 9) + 1, o = Array.from({ length: r }).map((x2, g2) => {
      const y = u("span", { className: "digit__num" }, [
        document.createTextNode(String(g2))
      ]);
      return g2 !== i2 && y.setAttribute("inert", ""), y.style.setProperty("--n", String(g2)), y;
    }), c2 = u("span", {
      part: `digit ${e}-digit`,
      className: "digit"
    }, o);
    c2.style.setProperty("--current", String(i2)), c2.style.setProperty("--length", String(r)), super(t, i2, c2, a), this.pos = s, this._onAnimationsFinish = () => {
  ...
  setup(a) {
    ...
    return P2(w2, (t, l2) => {
      s.add(t), M2(
        l2,
        async () => {
          i2 || (i2 = true, s.forEach(async (e) => {
            var u2;
            !e.value || !e.value.created || (e.value.willUpdate(), await g(), (u2 = e.value) == null || u2.didUpdate());
          }), await g(), i2 = false);
        }
        // { flush: 'pre' } // default
      ), B2(() => {
    ...
    }), (t, l2) => b2(t.$slots, "default");
  }
});
var R2 = ["batched", "trend", "plugins", "animated", "transformTiming", "spinTiming", "opacityTiming", "respectMotionPreference", "data-will-change", "digits", "innerHTML", "data"];
var x = T({
  inheritAttrs: false,
  __name: "index",
  props: {
    ...
    animated: { type: Boolean, default: () => J.defaultProps.animated },
    respectMotionPreference: { type: Boolean, default: () => J.defaultProps.respectMotionPreference },
    trend: { type: [Number, Function], default: () => J.defaultProps.trend },
    ...
    prefix: {},
    suffix: {},
    willChange: { type: Boolean, default: false }
  },
  emits: ["animationsstart", "animationsfinish"],
  setup(a, { expose: s, emit: i2 }) {
    const o = p();
    s({ el: o });
    const t = i2, l2 = c(() => new Intl.NumberFormat(a.locales, a.format)), e = c(() => nt(a.value, l2.value, a.prefix, a.suffix)), u2 = true_default ? void 0 : at(e.value), m2 = E2(w2, void 0);
    return m2 == null || m2(o, e), (n, d) => (A2(), F2("number-flow-vue", L2({
      ref_key: "el",
      ref: o
    }, n.$attrs, {
      batched: !!v2(m2),
...
function D2({
  respectMotionPreference: a = true
} = {}) {
  const s = p(false), i2 = p(false);
  return N2(() => {
    var o;
    s.value = q, i2.value = ((o = A) == null ? void 0 : o.matches) ?? false;
  }), $2((o) => {
    var l2;
    if (!h(a)) return;
    const t = ({ matches: e }) => {
    ...
    (l2 = A) == null || l2.addEventListener("change", t), o(() => {
      var e;
      (e = A) == null || e.removeEventListener("change", t);
    });
  }), c(
    () => s.value && (!h(a) || !i2.value)
  );
}
export {
  J as NumberFlowElement,
  j2 as NumberFlowGroup,
  l as continuous,
  x as default,
  D2 as useCanAnimate
};
//# sourceMappingURL=@number-flow_vue.js.map
