declare global {
  ...
  const addToInbox: typeof import('../../server/utils/inboxStore').addToInbox
  ...
  const listInbox: typeof import('../../server/utils/inboxStore').listInbox
...
declare global {
  // @ts-ignore
  export type { InboxMailItem } from '../../server/utils/inboxStore'
  import('../../server/utils/inboxStore')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/andrewchakdahah/Documents/ingen_crm/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/andrewchakdahah/Documents/ingen_crm/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { addToInbox, listInbox } from '/Users/andrewchakdahah/Documents/ingen_crm/server/utils/inboxStore';