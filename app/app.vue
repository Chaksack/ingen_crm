...
// Resolve favicon to a plain string URL at build time (SSR-safe)
const favicon = new URL('./assets/logo/favicon.png', import.meta.url).href
...
const title = 'Ingen'
const description = 'Ingen staff for managing customers, tasks and emails'
